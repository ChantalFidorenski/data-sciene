---
title: "Hausaufgabe 3 / Chantal Fidorenski"
output:
  html_document:
    df_print: paged
---
...
```
Nr1. Analyse, bei der nicht die Bücher, sondern die Autoren in den 
...
```
Der sup-Wert ist mit Absicht etwas höher angesetzt, da sich mein R 
bei kleineren Werten sonst aufhängt. 
```{r}
...
Oft werden dieselebn Autoren  gegenseitig erwähnt, z.B.: 
{Thomas Harris} => {Stephen King} 
und direkt in der darauffolgenden Zeile 
